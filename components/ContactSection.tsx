...
const ContactSection: React.FC = () => {
    ...
    const isValidEmail = (email: string): boolean => {
        ...
        // Check for valid domain (has a dot and at least 2 characters after the last dot)
        const domainParts = domain.split('.');
        if (domainParts.length < 2 || domainParts[domainParts.length - 1].length < 2) {
            return false;
        }
        
        // Check for common fake/placeholder email patterns
    ...
    return (
        <section id="contact" className="py-20 md:py-32">
            <div className="max-w-screen-md mx-auto px-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6" noValidate>
                    ...
                    <div>
                        ...
                        {errors.message && (
                            <p className="mt-1 text-sm text-red-400 flex items-center">
                                <svg className="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 极速11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 极速00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clipRule="evenodd"></path>
                                </svg>
                                {errors.message}
                            </p>
                        )}
                    ...
                    <div className="text-center">
                        ...
                        >
                            {status === 'sending' ? (
                                <>
                                    <svg className="animate-spin -ml-1 mr-3 h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="极速 24">
                ...
                {status === 'error' && (
                    <div className="mt极速 text-center text-red-400 bg-red-900/50 p-4 rounded-lg">
