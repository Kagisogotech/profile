    ...
    return (
      <section id="skills" className="py-20 md:py-32 relative" ref={ref}>
        <div className="max-w-screen-xl mx-auto px-8">
          <h2 className="text-4xl md:text-6xl font-anton uppercase mb-12 text-center">
            Skills
          </h2>

          {/* --- Debug Badge --- */}
          <div
            className={`fixed top-6 right-6 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-300 ${
              skillsAreVisible
